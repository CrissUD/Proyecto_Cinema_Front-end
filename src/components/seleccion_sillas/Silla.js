...
export default class Silla extends Component {
    ...
    state = {
        ...
        url: this.props.url_silla,
        codigo: this.props.codigo_silla
    }

    seleccionarSilla = async () =>{
        if(this.state.tipo_silla==='preferencial' && this.state.estado_silla==='disponible'){
        ...
        if(this.state.tipo_silla==='general' && this.state.estado_silla==='disponible'){
